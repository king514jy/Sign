package ky.display
{
	...
	import ky.utils.QRCodeParameter;
	...
	public class NetworkPicGroup extends Sprite
	{
		...
		/**
		 *分享图片 
		 * @param logo 获取二维码中添加的logo
		 * 
		 */
		public function share(parameter:QRCodeParameter,logo:BitmapData=null):void
		{
			var obj:Object = new Object();
			//bmd:BitmapData,netID:String,id:String(NetWorkPic的id)
			obj.bmd = _picBmpData;
			obj.netID = this.netID;
			obj.id = this.id;
			obj.logo = logo;
			obj.qrParameter = parameter;
			dispatchEvent(new NetDataEvent(ModuleEventMode.SHARE_UPLOAD,false,false,0,obj));
		}
